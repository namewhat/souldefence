<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wamp64\www\souldefence\public/../application/admin\view\index\index.html";i:1501815651;s:88:"D:\wamp64\www\souldefence\public/../application/admin\view\template\javascript_vars.html";i:1499219805;s:81:"D:\wamp64\www\souldefence\public/../application/admin\view\template\nav_left.html";i:1499417875;s:81:"D:\wamp64\www\souldefence\public/../application/admin\view\template\nav_menu.html";i:1499219805;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        ...
        <?php switch($info['id']): case "1": ?><nav class="nav navbar-nav">
    <ul class="cl">
        <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 添加 <i class="Hui-iconfont">&#xe6d5;</i></a>
            <ul class="dropDown-menu menu radius box-shadow">
                <li><a href="javascript:;" onclick="layer_open('添加', '<?php echo url('AdminGroup/add'); ?>');"><i class="Hui-iconfont">&#xe681;</i> 添加分组</a></li>
                <li><a href="javascript:;" onclick="layer_open('添加', '<?php echo url('AdminUser/add'); ?>');"><i  class="Hui-iconfont">&#xe607;</i> 添加用户</a></li>
                <li><a href="javascript:;" onclick="layer_open('添加', '<?php echo url('AdminNode/add'); ?>');"><i  class="Hui-iconfont">&#xe626;</i> 添加节点</a></li>
            </ul>
        </li>
    </ul>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li><input type="button" name="time" id="time"></li>
                    <li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">切换服务器 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="layer_open('确认切换到服务器1吗？', '', {fn:function() {layer.alert('切换成功')}});" id="1">服务器1</a></li>
                            <li><a href="javascript:;" onclick="switchServer($this.id)" id="2">服务器2</a></li>
                            <li><a href="javascript:;" onclick="switchServer($thid.id)" id="3">服务器3</a></li>
                        </ul>
                    </li>
